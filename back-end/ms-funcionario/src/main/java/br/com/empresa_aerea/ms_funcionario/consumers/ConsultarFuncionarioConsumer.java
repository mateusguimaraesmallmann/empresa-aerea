...
@Component
public class ConsultarFuncionarioConsumer {
    ...
    @RabbitListener(queues = "ms-funcionario-consultar-funcionario")
    public void consultarFuncionario(Message message) throws JsonProcessingException {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            FuncionarioConsultaRequestDTO funcionarioDTO = objectMapper.readValue(message.getBody(), FuncionarioConsultaRequestDTO.class);

            FuncionarioResponseDTO funcionarioResponseDTO = service.consultarFuncionario(funcionarioDTO);
            ...
            rabbitTemplate.send(EXCHANGE_NAME, "saga-ms-funcionario-consultar-funcionario", responseMessage);
        } catch (Exception ex) {
