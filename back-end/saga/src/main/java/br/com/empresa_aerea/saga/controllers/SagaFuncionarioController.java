...
public class SagaFuncionarioController {
    ...
    public SagaFuncionarioController(RabbitTemplate rabbitTemplate,
    ...
    public ResponseEntity<Object> cadastrarFuncionario(@Validated @RequestBody Map<String, Object> funcionarioDto) {
        ...
        try {
            ...
            logger.error("Erro na saga de cadastro de funcionário", e);
