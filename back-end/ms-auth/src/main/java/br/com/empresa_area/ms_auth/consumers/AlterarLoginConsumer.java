...
@Component
public class AlterarLoginConsumer {
    ...
    @RabbitListener(queues = "ms-auth-alterar-login")
    public void cadastrarLogin(Message message) throws JsonProcessingException {
        try {
            ...
            rabbitTemplate.send(EXCHANGE_NAME, "saga-ms-auth-alterar-login", responseMessage);
        } catch (Exception e) {
